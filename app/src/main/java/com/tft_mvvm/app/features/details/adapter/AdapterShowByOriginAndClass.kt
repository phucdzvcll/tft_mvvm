...
class AdapterShowByOriginAndClass(
    private val champs: ArrayList<ItemHolderViewHolder.Champ>,
    private val onItemClickListener: OnItemClickListener
) : RecyclerView.Adapter<AdapterShowByOriginAndClass.DataViewHolder>() {

    class DataViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(champ: ItemHolderViewHolder.Champ, onItemClickListener: OnItemClickListener) {
    ...
    fun addData(list: List<ItemHolderViewHolder.Champ>) {
        champs.clear()
        champs.addAll(list)
