...
class MyAdapter(private val champs: ArrayList<com.example.presentation.features.champs.model.model.Champ>) : RecyclerView.Adapter<MyAdapter.DataViewHolder>() {
    class DataViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(champ: com.example.presentation.features.champs.model.model.Champ) {
